			...
			<div style={{ flexBasis: "550px" }}>
				<div className="flex flex-col align-center border-4 border-dotted rounded-lg text-lg flex-grow">
					...
					<div className="p-5 flex flex-col items-center">
						...
						<div>
							<button className="py-2 px-5 bg-gray-50 text-sm rounded-md mr-3 border border-gray-200">
								Add 5 items
							</button>
							<button className="py-2 px-5 bg-gray-50 text-sm rounded-md mr-3 border border-gray-200">
								Add 10 items
							</button>
							<button className="py-2 px-5 bg-gray-50 text-sm rounded-md border border-gray-200">
								Add 20 items
							</button>
						</div>
						<div className="mt-3 text-xs text-center">
							...
							<br />
							Or you can{" "}
							<span className="underline cursor-pointer" onClick={() => setOpen(true)}>
