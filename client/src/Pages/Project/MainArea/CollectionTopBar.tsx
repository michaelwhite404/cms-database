...
export default function CollectionTopBar({
	...
	return (
		<div className="flex justify-between w-full items-center px-4 py-2 bg-gray-100 border-b border-gray-300">
			...
			<div className="flex items-center">
				<button
					className="order-1 mr-3 inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:order-0 sm:ml-0"
