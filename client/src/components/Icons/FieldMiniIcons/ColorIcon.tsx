export default function ColorIcon({ className }: { className?: string }) {
	return (
		<svg
			data-icon="FieldColorSmall"
			aria-hidden="true"
			focusable="false"
			width="14"
			height="15"
